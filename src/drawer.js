...
export default function MiniDrawer() {
    ...
    const [page_change, setpage_change] = useState(
        0
      );
    ...
    const handlepageChange = value => setpage_change(value);
            ...
            >
                ...
                <List>
                    {['Home', 'About Us'].map((text, index) => (
                        <ListItem button key={text} onClick={()=>{handlepageChange(index)}} >
                            <ListItemIcon>{index % 2 === 0 ? <HomeIcon /> : <AboutUsIcon/>}</ListItemIcon>
